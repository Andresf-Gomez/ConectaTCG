      ...
      <div className="max-w-4xl mx-auto px-4 py-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mb-8">
          <button
            ...
            className="flex items-center gap-3 w-full px-5 py-4 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-2xl hover:border-blue-400 dark:hover:border-blue-600 hover:bg-slate-50 dark:hover:bg-slate-800/50 transition text-left"
          >
          ...
          <button
            onClick={() => setPage('adminSets')}
            className="flex items-center gap-3 w-full px-5 py-4 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-2xl hover:border-violet-400 dark:hover:border-violet-600 hover:bg-slate-50 dark:hover:bg-slate-800/50 transition text-left"
          >
